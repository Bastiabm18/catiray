...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen max-h-screen overflow-y-hidden font-bruno-ace-sc md:text-md text-sm  flex items-center justify-center bg-bg-main p-4 font-body">
      <motion.div
        className="bg-red-500/30  p-8 rounded-lg shadow-xl w-full max-w-md border border-red-500/70 relative"
        variants={formVariants}
        initial="hidden"
        animate="visible"
      >
        {/* Logo de Neón Centrado */}
        <div className="flex justify-center -mt-20 mb-8"> {/* Ajustado para sobresalir un poco y centrarse */}
          <NeonSign />
        </div>
        ...
        <div className="mt-8 text-center text-neutral-dark">
          <p className="mb-2 text-gray-300">
            ¿No tienes cuenta? <br></br> <Link href="/signup" className="text-brand-secondary text-blue-500 hover:underline font-medium">Crea una aquí</Link>
          </p>
